      ...
      <v-col dense lg="4" cols="sm" class="pb-2">
        ...
        <v-card class="mt-2" :color="system_color">
          <v-list subheader color="transparent">
            ...
            <v-list-item>
              <v-list-item-content class="py-0">
                <v-list-item-subtitle>SessionID: {{ $store.getters.sessionId }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          </v-list>
        </v-card>
...
import BuyMeACoffee from '../components/donate/BuyMeACoffee.vue'
import YooMoney from '../components/donate/YooMoney.vue'
export default {
  mixins: [systemColor],
