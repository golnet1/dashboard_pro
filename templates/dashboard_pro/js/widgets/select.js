const SelectWidget = {
    ...
    fields: {
        params: [
            ...
            { key: 'help', type: 'info', text: 'help_options_format' },
            { key: 'options', label: 'field_options_json', type: 'textarea', rows: 4, placeholder: '[{"label":"Вкл","value":"1","icon":"fas fa-check"}]' },
        ],
        advanced: [
    ...
    defaults: () => ({ icon: 'fas fa-list', icon_type: 'icon', height: 130, options: JSON.stringify([{label:window.__t('default_on'),value:'1'},{label:window.__t('default_off'),value:'0'}]) }),
    template: `
    ...
    data() {
        return { currentValue: null, loading: false, timer: null, isAlive: true, availTimer: null };
    },
    computed: {
        aliveDisabled() {
