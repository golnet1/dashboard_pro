const ClockWidget = {
    ...
    fields: {
        params: [
            ...
            { key: 'sizeTime', label: 'field_size_time', type: 'number', default: 48 },
            { key: 'sizeDate', label: 'field_size_date', type: 'number', default: 16 },
            { key: 'viewTime', label: 'field_show_time', type: 'checkbox', default: true },
            { key: 'viewDate', label: 'field_show_date', type: 'checkbox', default: true },
        ],
        advanced: [
