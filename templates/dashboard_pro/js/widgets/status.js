const StatusWidget = {
    ...
    defaults: () => ({ icon: 'fas fa-info-circle', icon_type: 'icon', height: 130, statuses: JSON.stringify([{status:'0',title:window.__t('default_off'),icon:'fas fa-power-off',color:'#ef4444'},{status:'1',title:window.__t('default_on'),icon:'fas fa-check',color:'#22c55e'}]) }),
    template: `
